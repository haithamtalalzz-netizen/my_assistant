        ...
        child: ListView(
          ...
          children: [
            ...
            groupTile(
                ...
                [
                  ...
                  push(Icons.savings_outlined, tr('الادخار', 'Savings'),
                      const SavingsScreen()),
                  push(Icons.diamond_outlined, tr('أموالي الخارجية', 'My assets'),
                      const AssetsScreen()),
            ...
            groupTile(Icons.favorite_outline,
              ...
              push(Icons.dashboard_outlined, tr('لوحة الصحة', 'Health hub'),
                  const HealthHubScreen()),
              top(3, Icons.task_alt, tr('العادات', 'Habits')),
              push(Icons.fitness_center, tr('الجيم', 'Gym'), const GymScreen()),
              push(Icons.monitor_weight_outlined,
                  tr('التقدم البدني', 'Body progress'), const ProgressScreen()),
              push(Icons.medical_information_outlined,
                  tr('الملف الطبي', 'Medical file'), const MedicalScreen()),
              push(Icons.medication_outlined, tr('صيدلية البيت', 'Home pharmacy'),
            ...
            groupTile(Icons.home_outlined,
              ...
              push(Icons.verified_outlined, tr('أرشيف الضمانات', 'Warranties'),
                  const WarrantyScreen()),
              push(Icons.speed_outlined, tr('قراءات العدادات', 'Meter readings'),
                  const MetersScreen()),
              push(Icons.yard_outlined, tr('نباتات البيت', 'Home plants'),
                  const PlantsScreen()),
              push(Icons.checkroom_outlined, tr('خزانة الملابس', 'Wardrobe'),
                  const WardrobeScreen()),
              push(Icons.shopping_cart_outlined,
                  tr('قائمة التسوق', 'Shopping list'), const ShoppingListScreen()),
              push(Icons.restaurant_menu_outlined, tr('دفتر الوصفات', 'Recipes'),
                  const RecipesScreen()),
            ]),
            groupTile(
                Icons.self_improvement, tr('حياتي وتطوّري', 'My life & growth'), [
              push(Icons.menu_book_outlined, tr('مراجعة القرآن', 'Quran review'),
                  const QuranScreen()),
              push(Icons.flag_outlined, tr('التحديات', 'Challenges'),
                  const ChallengesScreen()),
              push(Icons.auto_stories_outlined, tr('اليوميات', 'Diary'),
                  const DiaryScreen()),
              push(Icons.emoji_events_outlined, tr('عدّاد الإقلاع', 'Quit counter'),
                  const QuitScreen()),
              push(Icons.hourglass_empty, tr('الكبسولة الزمنية', 'Time capsule'),
                  const CapsuleScreen()),
              push(Icons.diversity_1_outlined, tr('صلة الرحم', 'Keep in touch'),
                  const RelativesScreen()),
              push(Icons.lock_outline, tr('الخزنة السرية', 'Secret vault'),
            ...
            groupTile(Icons.insights_outlined,
              ...
              push(Icons.calendar_month_outlined,
                  tr('تقويم النتيجة', 'Activity calendar'), const CalendarScreen()),
              push(Icons.inbox_outlined, tr('صندوق الوارد', 'Inbox'),
                  const InboxScreen()),
              push(Icons.event_repeat, tr('التخطيط الأسبوعي', 'Weekly planning'),
